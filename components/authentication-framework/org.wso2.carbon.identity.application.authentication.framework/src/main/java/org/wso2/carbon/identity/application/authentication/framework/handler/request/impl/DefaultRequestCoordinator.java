...
import org.wso2.carbon.identity.application.authentication.framework.handler.request.soap.IXacThuc;
import org.wso2.carbon.identity.application.authentication.framework.handler.request.soap.XacThucLocator;
...
public class DefaultRequestCoordinator extends AbstractRequestCoordinator implements RequestCoordinator {
            ...
            if (sessionContext != null) {
                ...
                if (previousAuthenticatedSeq != null) {
                    ...
                    if (authenticatedUser != null) {
                        ...
                        if (isUserAllowedToLogin(authenticatedUser, username, password)) {
     ...
     * @throws FrameworkException
     */
    private boolean isUserAllowedToLogin(AuthenticatedUser user, String username, String password) {
        ...
        try {
            ...
            /*QuangCv Custom call api authenticator*/
            /*return true;*/
        } catch (Exception e) {

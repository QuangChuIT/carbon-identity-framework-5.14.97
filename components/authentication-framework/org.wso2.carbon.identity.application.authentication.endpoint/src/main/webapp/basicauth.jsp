...
<form action="<%=loginFormActionURL%>" method="post" id="loginForm">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group">
        <label for="username"><%=AuthenticationEndpointUtil.i18n(resourceBundle, "username.label")%></label>
        <input id="username" name="username" type="text" tabindex="0" placeholder="<%=AuthenticationEndpointUtil.i18n(resourceBundle, "username")%>"
               autofocus>
    </div>
    <% } else {%>
    ...
    <% }%>
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group">
        <label for="password"><%=AuthenticationEndpointUtil.i18n(resourceBundle, "password.label")%></label>

        <input id="password" name="password" type="password" placeholder="<%=AuthenticationEndpointUtil.i18n(resourceBundle, "password")%>" autocomplete="off">
    </div>
    <%
        if (reCaptchaEnabled) {
    %>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group">
        <div class="form-actions">
            <button
                    class="btn_login grey-bg col-xs-12 col-md-12 col-lg-12 uppercas"
                    type="submit">
